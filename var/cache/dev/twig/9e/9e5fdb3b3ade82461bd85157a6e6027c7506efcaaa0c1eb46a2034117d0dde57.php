...
class __TwigTemplate_a148446dce5923a518a8f45c0df4faa3c008ad53aba8a50c70bf0867b7fbb196 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("admin/layout.html.twig", "admin/category/show.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 20, $this->source); })()), "enabled", [], "any", false, false, false, 20)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "admin/category/show.html.twig", "/opt/lampp/htdocs/blogSymfony/templates/admin/category/show.html.twig");
    }
}
